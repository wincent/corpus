 ...
 * @flow
 *
 * This is an autogenerated libdef for: electron-v4.0.0 main process
 */
...
declare module 'electron' {
  declare module.exports: {
    app: {
      ...
      on: ((eventName: 'will-finish-launching', callback: () => void) => void) &
        ((eventName: 'ready', callback: (launchInfo: {}) => void) => void) &
        ((eventName: 'window-all-closed', callback: () => void) => void) &
        ((eventName: 'before-quit', callback: (event: Event) => void) => void) &
    ...
    systemPreferences: {
      ...
      subscribeLocalNotification: (event: string, callback: Function) => number,
